...
gulp.task('default', function() {
	...
	console.log('gulp wordpress-lang            to compile the lsx-cew.pot, lsx-cew-en_EN.po and lsx-cew-en_EN.mo');
});
...
gulp.task('wordpress-pot', function() {
	return gulp.src('**/*.php')
		...
		.pipe(wppot({
			domain: 'lsx-cew',
			package: 'lsx-cew',
			bugReport: 'https://github.com/lightspeeddevelopment/lsx-cew/issues',
			team: 'LightSpeed <webmaster@lsdev.biz>'
		}))
		.pipe(gulp.dest('languages/lsx-cew.pot'))
});
...
gulp.task('wordpress-po', function() {
	return gulp.src('**/*.php')
		...
		.pipe(gulp.dest('languages/lsx-cew-en_EN.po'))
});

gulp.task('wordpress-po-mo', ['wordpress-po'], function() {
	return gulp.src('languages/lsx-cew-en_EN.po')
		.pipe(gettext())
